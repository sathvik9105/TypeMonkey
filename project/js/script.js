...
const iwName = document.getElementById("iwName");
...
thirty.addEventListener("click",function(){
  timer = 30;
  factor = 2;
  limitColor(thirty,sixty,ninty,fifteen);
  time.innerText = timer;
});
...
ninty.addEventListener("click",function(){
  timer = 90;
  factor = 1.5;
  limitColor(ninty,thirty,sixty,fifteen);
  time.innerText = timer;
});
...
hard.addEventListener("click",function(){
  difficulty = 3;
  displayTest(difficulty);
  limitColor(hard,easy,med);
});

//set the color of time and difficulty
function limitColor(itema,itemr ){
  itema.classList.add('black');
  itemr.classList.remove('black');
}
...
restartBtn.addEventListener("click",function(){
  ...
  iw.classList.remove("current")
  time.innerText = timer;
  timeName.innerText = "Timer:";
  cw.innerText = wordsCorrect;
  cwName.innerText = "Correct:";
  iw.innerText = wordsIncorrect;
  iwName.innerText = "Incorrect:"
